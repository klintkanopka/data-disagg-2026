...
write_csv(nhpi_admit, 'tab/nhpi_admit.csv')

ggplot(nhpi_admit, aes(x=term_cd, y=admit_rate, color=group)) +
  geom_line() +
  geom_point() +
  scale_color_viridis_d() +
  labs(title='multiracial nhpi admit rates') +
  theme_minimal()

ggsave('fig/nhpi-admit.png', height=6, width=8)
